...
class LightHSLOpcode(IntEnum):
    ...
    LIGHT_HSL_HUE_SET_UNACKNOWLEDGED = 0x8207
...
class LightHSLSetupOpcode(IntEnum):
    ...
    LIGHT_HSL_DEFAULT_SET_UNACKNOWLEDGED = 0x8208
    LIGHT_HSL_RANGE_SET = 0x8281
    LIGHT_HSL_RANGE_SET_UNACKNOWLEDGED = 0x8282
...
LightHSLStatusMinimal = LightHSL
...
LightHSLTargetGet = Struct()

LightHSLTargetStatusMinimal = Struct(
    "hsl_lightness_target" / Int16ul,
    "hsl_hue_target" / Int16ul,
    "hsl_saturation_target" / Int16ul
)

LightHSLTargetStatusOptional = Struct(
    Embedded(LightHSLStatusMinimal),
    "remaining_time" / TransitionTimeAdapter(TransitionTime, allow_unknown=True)
)

LightHSLTargetStatus = NamedSelect(
    optional=LightHSLTargetStatusOptional,
    minimal=LightHSLTargetStatusMinimal
)

LightHSLHueGet = Struct()
...
LightHSLMessage = SwitchStruct(
    ...
    "params" / Switch(
        this.opcode,
        {
            ...
            LightHSLOpcode.LIGHT_HSL_HUE_GET: LightHSLHueGet,
            ...
            LightHSLOpcode.LIGHT_HSL_SATURATION_GET: LightHSLSaturationGet,
            ...
            LightHSLOpcode.LIGHT_HSL_TARGET_GET: LightHSLTargetGet,
            LightHSLOpcode.LIGHT_HSL_TARGET_STATUS: LightHSLTargetStatus,
            LightHSLOpcode.LIGHT_HSL_DEFAULT_GET: LightHSLDefaultGet,
            LightHSLOpcode.LIGHT_HSL_DEFAULT_STATUS: LightHSLDefault,
            LightHSLOpcode.LIGHT_HSL_RANGE_GET: LightHSLRangeGet,
...
LightHSLSetupMessage = SwitchStruct(
    ...
    "params" / Switch(
        this.opcode,
        {
            LightHSLSetupOpcode.LIGHT_HSL_DEFAULT_SET: LightHSLDefault,
            LightHSLSetupOpcode.LIGHT_HSL_DEFAULT_SET_UNACKNOWLEDGED: LightHSLDefault,
            LightHSLSetupOpcode.LIGHT_HSL_RANGE_SET: LightHSLRange,
            LightHSLSetupOpcode.LIGHT_HSL_RANGE_SET_UNACKNOWLEDGED: LightHSLRange
        }
    )
)